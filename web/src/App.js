  ...
  const handlePredict = async () => {
    ...
    if (prediction) {
      ...
      for (let i = 0; i < 3; i++) {
        ...
        let resName = predJSON[i].name
        if ((resName.includes('여자배우')) || (resName.includes('배우'))) {
          nameTag.innerText = `${predJSON[i].name.split(' ')[1]}`
        } else {
          ...
          <div className='preds'>
            <span className='resultSpan1'>
              ...
              <h3 className='name'>{predjson[0].name}</h3>
                 {/* {((predjson[0].name.includes('여자배우')) || (predjson[0].name.includes('배우'))) ? predjson[0].name.split(' ')[-1] : predjson[0].name} */}
              </h3>
            </span>
            <span className='resultSpan2'>
              ...
              <h3 className='name'>
                 {/* {((predjson[1].name.includes('여자배우')) || (predjson[1].name.includes('배우'))) ? predjson[1].name.split(' ')[-1] : predjson[1].name} */}
              </h3>
            </span>
            <span className='resultSpan3'>
              ...
              <h3 className='name'>
                 {/* {((predjson[2].name.includes('여자배우')) || (predjson[2].name.includes('배우'))) ? predjson[2].name.split(' ')[-1] : predjson[2].name} */}
              </h3>
            </span>
          </div>}
      </div>
