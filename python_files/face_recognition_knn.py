...
def train(train_dir, test_dir, model_save_path=None, n_neighbors=None, knn_algo='ball_tree', verbose=True):
    """
...
#                 if verbose:
#                     print("Image trained: {}".format(img_path))
...
#                 if verbose:
#                     print("Image trained: {}".format(img_path))
                X_test.append(face_recognition.face_encodings(image, known_face_locations=face_bounding_boxes, model="large")[0])
...
#     !mv malgun.ttf /data/home/chaewon215/ECNV/Dev Project
    ...
    draw.font = ImageFont.truetype('/data/home/chaewon215/ECNV/Dev Project/malgun.ttf', 13)
    ...
    font = ImageFont.truetype('/data/home/chaewon215/ECNV/Dev Project/malgun.ttf', font_size)
    draw.text((left + 6, bottom + text_height - 50), name_str, fill=(255, 255, 255, 255))
    ...
    pil_image.show()
    pil_image.save("/data/home/chaewon215/ECNV/Dev Project/")
...
#     classifier = train("knn_examples/train", model_save_path="trained_knn_model.clf", n_neighbors=2)
    classifier = train('../MTCNN/train_dir', './model_save.clf', n_neighbors=25, verbose=True)
